...
<?php include("includes/header.php"); ?>
    ...
    <p class="index-slogan mt-2 mb-4">We're excited you've decided to cast your vote today. Let's help you get started.</p>
        ...
        <section class="thumbs-container shadow mt-4 pt-4 pl-5 pr-5 pb-5 mb-5">
            ...
            <div class="input-group mt-3 mb-3 mr-sm-2 shadow-sm">
        ...
        <table class="table table-striped" id="myTable">
            ...
            <tr>
                ...
                <td class="actions">
					...
					<a href="result.php?id=<?=$poll['id']?>" class="btn btn-dark" title="View Results"><i class="fas fa-chart-bar fa-xs"></i></a>
                </td>
            </tr>
            <?php endforeach; ?>
            </tbody>
