    ...
    <p class="index-slogan mt-2 mb-4">We're excited you've decided to cast your vote today. Let's help you get started.</p>
        ...
        <table class="table table-striped" id="myTable">
            ...
            <tr>
				...
				<td><?=$poll['answers']?></td>
                <td class="actions">
					<a href="vote.php?id=<?=$poll['id']?>" class="btn btn-outline-dark" title="View Poll"><i class="fas fa-vote-yea fa-xs"></i></a>
					<a href="vote.php?id=<?=$poll['id']?>" class="btn btn-dark" title="View Poll"><i class="fas fa-chart-bar fa-xs"></i></a>
                </td>
            </tr>
            <?php endforeach; ?>
            </tbody>
